...
if (isset($_POST['signup'])) {
  ...
  $sql = "INSERT INTO  tblusers(FullName,EmailId,ContactNo,License,Password) VALUES(:fname,:email,:mobile,:license,:password)";
              ...
              <form method="post" name="signup" onSubmit="return valid();">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="mobileno" placeholder="Mobile Number"
                    pattern="^04\d{8}$" title="Mobile number must be 10 digits and start with 04" maxlength="10"
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="license" placeholder="License Number"
                    required="required" pattern="^\d{8}$" title="License number must be exactly 8 digits" maxlength="8"
                    minlength="8">
                </div>
