...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['updateprofile'])) {
    ...
    $sql = "update tblusers set FullName=:name,ContactNo=:mobileno,License=:license,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";
                    ...
                    <form method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control white_bg" name="mobilenumber"
                          value="<?php echo htmlentities($result->ContactNo); ?>" id="phone-number" type="text"
                          pattern="^04\d{8}$" title="Phone number must be 10 digits and start with 04" maxlength="10"
                          minlength="10" required>
                      </div>

                      <div class="form-group">
                        <label class="control-label" for="license-number">License Number</label>
                        <input class="form-control white_bg" name="license"
                          value="<?php echo htmlentities($result->License); ?>" id="license-number" type="text"
                          pattern="^\d{8}$" title="License number must be exactly 8 digits" maxlength="8" minlength="8"
                          required>
                      </div>
