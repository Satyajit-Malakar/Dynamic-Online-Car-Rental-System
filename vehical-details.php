        ...
        <div class="main_features">
          <ul>
            ...
            <li> <i class="fa fa-calendar" aria-hidden="true"></i>
              ...
              <p style="font-size: 14px;">Reg.Year</p>
            </li>
            ...
            <li> <i class="fa fa-user-plus" aria-hidden="true"></i>
              ...
              <p style="font-size: 14px;">Seats</p>
            </li>

            <li style="<?php echo ($vehicleQuantity > 0) ? 'color: green;' : 'color: red;font-size: 16px;'; ?>">
            <p style="font-size: 14px;margin-bottom: 15px;">Status</p>
          ...
          <?php if($_SESSION['login'])
              ...
              <div class="form-group">
                  <input type="submit" 
                        ...
                        name="submit" 
                        value="Book Now"
                        <?php echo ($vehicleQuantity > 0) ? '' : 'disabled'; ?>
                        style="background-color: #007BFF; color: white; cursor: pointer;"
...
{ 
  if($query1->rowCount()==0)
  {
    $update_quantity=$vehicleQuantity-1;
    $jsonFilePath = 'assets/Cars.json';
    $jsonData = file_get_contents($jsonFilePath);
    $vehiclesData = json_decode($jsonData, true);
    $vehicles = $vehiclesData[2]['data']; 
    //$update_quantity = '10'; // New quantity to update
